...
class Product(Base):
    ...
    category = Column(String(255), default=SupplyCategory.other.value)
    ...
    unit = Column(String(255), default="kg")
    status = Column(String(255), default=SupplyStatus.in_stock.value)
    
    # Supply Details
    supplier_name = Column(String(255), nullable=True)
    batch_number = Column(String(255), nullable=True, index=True)
